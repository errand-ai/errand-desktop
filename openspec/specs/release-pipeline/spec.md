## Purpose
Defines the CI build, sign, notarize, and release contract: the universal binary requirement, the single-DMG-per-release rule, the Info.plist minimum version, and the GitHub Release naming convention the cask depends on.
